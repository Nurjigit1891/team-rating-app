...
import bakaiPhoto from '../assets/bakai.jpg';
import markusPhoto from '../assets/markus.jpg';
import brinjarPhoto from '../assets/brinjar.jpg';
import timaPhoto from '../assets/tima.jpg';
import aidarPhoto from '../assets/aidar.jpg';
import rusPhoto from '../assets/rus.jpg';
import usufPhoto from '../assets/usuf.jpg';
import tilegenPhoto from '../assets/tilegen.png';
import arsenPhoto from '../assets/arsen.png';
import islamPhoto from '../assets/islam.png';
import chikaPhoto from '../assets/chika.png';
import myrzaPhoto from '../assets/myrza.jpg';
import mirsPhoto from '../assets/mirs.jpg';
import nurbaPhoto from '../assets/nurba.png';
import shifuPhoto from '../assets/shifu.jpg';
import alibaPhoto from '../assets/aliba.png';
import azaPhoto from '../assets/aza.png';
import noaPhoto from '../assets/noa.jpg';
import emilPhoto from '../assets/emil.jpg';
import suliPhoto from '../assets/suli.jpg';
import farhatPhoto from '../assets/farhat.png';
import yasirPhoto from '../assets/yasir.png';
import kanaPhoto from '../assets/kana.jpg';
import emirPhoto from '../assets/emir.jpg';
...
const PLAYERS = [
  { id: 1, name: 'Bakai', photo: bakaiPhoto },
  { id: 2, name: 'Markus', photo: markusPhoto },
  { id: 3, name: 'Brinjar', photo: brinjarPhoto },
  { id: 4, name: 'Tima', photo: timaPhoto },
  { id: 5, name: 'Aidar', photo: aidarPhoto },
  { id: 6, name: 'Rus', photo: rusPhoto },
  { id: 7, name: 'Usuf', photo: usufPhoto },
  { id: 8, name: 'Tilegen', photo: tilegenPhoto },
  { id: 9, name: 'Arsen', photo: arsenPhoto },
  { id: 10, name: 'Islam', photo: islamPhoto },
  { id: 11, name: 'Chika', photo: chikaPhoto },
  { id: 12, name: 'Myrza', photo: myrzaPhoto },
  { id: 13, name: 'Mirs', photo: mirsPhoto },
  { id: 14, name: 'Nurba', photo: nurbaPhoto },
  { id: 15, name: 'Shifu', photo: shifuPhoto },
  { id: 16, name: 'Aliba', photo: alibaPhoto },
  { id: 17, name: 'Aza', photo: azaPhoto },
  { id: 18, name: 'Noa', photo: noaPhoto },
  { id: 19, name: 'Emil', photo: emilPhoto },
  { id: 20, name: 'Suli', photo: suliPhoto },
  { id: 21, name: 'Farhat', photo: farhatPhoto },
  { id: 22, name: 'Yasir', photo: yasirPhoto },
  { id: 23, name: 'Kana', photo: kanaPhoto },
  { id: 24, name: 'Emir', photo: emirPhoto },
];

export default function TeamRatingApp() {
